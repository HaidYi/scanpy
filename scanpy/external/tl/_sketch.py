...
def sketch(
    ...
    """\
    Cell sketching [Hie19gs]_ [Vishal22]_
    ...
    *sketch* is a function that can be used for summarizing the landscape of
    ...
    geoemetric sketching [Hie19gs]_, kernel herding [Vishal22]_, and simple
    ...
    if n_sketch >= adata.n_obs:
        replace = True
        logg.warn("n_sketch too large, adjusting to sampling with replacement.")
